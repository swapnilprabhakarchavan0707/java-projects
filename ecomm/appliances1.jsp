    ...
    <div class="container">
        <div class="product-detail">
            ...
            <div class="product-image">
                <img src="Philips Induction Cooktop.jpg" alt="Induction Cooktop">
            </div>

            <!-- Product Information -->
            <div class="product-info">
                <h3>Induction Cooktop</h3>
                <p><strong>Product Overview:</strong> A high-performance Philips induction cooktop that makes cooking faster, safer, and more energy-efficient.</p>
