...
<%
    ...
    if (request.getParameter("submit") != null) {
        ...
        try {
            ...
            String query = "UPDATE admins SET first_name = ?, last_name = ?, role = ?, correspondence_address = ?, permanent_address = ?, username = ?, password = ? WHERE admin_id = ?";
            ...
            preparedStatement.setInt(8, Integer.parseInt(adminId));
...
<head>
    ...
    <style>
        ...
        body {
    		...
    		background: url('edit_admin.jpg') no-repeat center center fixed;
    		background-size: cover;
    		display: flex;
    		justify-content: center;
    		align-items: flex-start; /* Align items towards the top while keeping some space */
    		min-height: 100vh; /* Ensure body fully covers the viewport */
    		color: #333;
	}
